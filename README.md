# @zibuthe7j11/mollitia-adipisci-tempore

![CI](https://github.com/zibuthe7j11/mollitia-adipisci-tempore/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@zibuthe7j11/mollitia-adipisci-tempore.svg?style=flat)](https://www.npmjs.com/package/@zibuthe7j11/mollitia-adipisci-tempore)
...
```
npm i @zibuthe7j11/mollitia-adipisci-tempore
```
...
const {
  createWarning,
  createDeprecation
} = require('@zibuthe7j11/mollitia-adipisci-tempore')
...
```js
const { createWarning } = require('@zibuthe7j11/mollitia-adipisci-tempore')
